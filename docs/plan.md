...
> **Status:** v0.7.7 — M0, M1, M1a, M2, M2b, M3a, M3t, M3c, M3d, M3e, M3f, M3i (two slices: see what exists, take back what is sherpa's) done; order from here: M3h → M5 → M7a → M6-lite → M4 → M6 → M3b → M7 (§7.3, §9, §10)
