...
| [0036](0036-stdlib-schema-validator.md) | `sherpa/schema.py` validates the shipped schemas with the stdlib on every reader, in production as in the tests; `jsonschema` stays a dev extra as the reference on one input matrix — amends ADR-0005 | accepted |
