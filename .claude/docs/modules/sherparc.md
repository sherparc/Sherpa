...
> Owner of every fact about the module `sherparc`. Agents and skills link here instead of
> copying (owner principle). Keep anchor headings small and stable — links hang on them.

<!-- sherpa:begin facts -->
## facts (as of 2026-09-19)

| field | value |
|---|---|
| path | `.` |
| kind | python module (`pyproject.toml`) |
| files / LOC | 178 / 22122 — 7 files in 1 sub-units, described in their own owner docs |
| commits 90d / 30d | 46 / 46 · 2 authors |
| depends on | — |
| dependents | — |
| tested by | — |
| hotspots | `docs/plan.md`, `tests/test_apply.py`, `README.md` |
| contains | [src/sherpa/apply](src-sherpa-apply.md) (7 files, 23 commits/90d) |
<!-- sherpa:end facts -->
