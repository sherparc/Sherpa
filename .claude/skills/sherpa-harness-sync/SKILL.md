---
name: sherpa-harness-sync
description: "Keep the owner doc of sherpa-harness in sync with the code: run on a schedule or after larger merges to .."
---

# sherpa-harness — librarian

<!-- sherpa:begin scope -->
## Scope

- pathspec: `.` — 30 commits/30d, suggested cadence: weekly
- owner doc: [.claude/docs/modules/sherpa-harness.md](../../docs/modules/sherpa-harness.md)
- the facts block in the owner doc is regenerated by `sherpa apply` — never edit it by hand
- scanned: as of 2026-09-17
<!-- sherpa:end scope -->
